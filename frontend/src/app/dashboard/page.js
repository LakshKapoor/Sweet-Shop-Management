...
const handleDelete = (id) =>{
  ...
  .then(() => fetchExpenses(selectedGroupId))
  .catch((err)=>console.log(err))
}
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-indigo-600 mb-4">Expense Tracker</h1>
            ...
            <div className=" items-right px-4 py-2 shadow-sm grid grid-cols-1 lg:grid-cols-3 gap-6">
            <button
          ...
          {currentUserId && (
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-lg border border-gray-200 shadow-sm">
              ...
              <span className="px-3 py-1 bg-indigo-50 border border-indigo-200 rounded-md text-sm font-semibold text-indigo-700">
                            ...
                            {expense.splits.map((split) => (
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  <span className="text-sm text-gray-700">
                                    <span className="font-medium">{split.userId.name}</span> - ₹{split.share}
                                  </span>
                                  <span
                                ...
                                <div>
                                  {split.userId._id === currentUserId && split.status === "UNPAID" && (
                                    <button
                                  ...
                                  {expense.paidBy._id === currentUserId && split.status === "PAID" && (
                                    <button
